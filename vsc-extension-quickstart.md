...
* `themes/spring-color-theme.json` (and summer, autumn, winter) - color theme definition files.
* `scripts/generate-season-themes.mjs` - regenerates all four themes from shared rules and palettes.
